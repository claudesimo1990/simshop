        ...
        <div class="py-20">
            <div class="grid grid-cols-1 md:grid-flow-col md:auto-rows-min md:grid-cols-12 md:gap-x-8 md:gap-y-16">
                ...
                <div class="col-span-1 md:col-span-2 lg:col-start-1 lg:row-start-1">
                    <x-application-logo class="w-auto"></x-application-logo>
{{--                    <img src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600" alt="" class="h-8 w-auto">--}}
                </div>

                <!-- Sitemap sections -->
                <div class="ml-4 col-span-6 mt-10 grid grid-cols-2 gap-8 sm:grid-cols-3 md:col-span-8 md:col-start-3 md:row-start-1 md:mt-0 lg:col-span-6 lg:col-start-2">
