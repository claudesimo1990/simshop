<div class="bg-white" x-data="dropdown">
    <!--
      Mobile menu
        ...
        <div class="fixed inset-0 z-40 flex">
            <!--
              ...
              Leaving: "transition ease-in-out duration-300 transform"
                ...
                To: "-translate-x-full"
            -->
            <div class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" x-cloak x-show="open">
                ...
                <div class="mt-2">
                    ...
                    <div id="tabs-1-panel-1" class="space-y-12 px-4 py-6" aria-labelledby="tabs-1-tab-1" role="tabpanel" tabindex="0" x-cloak x-show="open">
                    ...
                    <div id="tabs-1-panel-2" class="space-y-12 px-4 py-6" aria-labelledby="tabs-1-tab-2" role="tabpanel" tabindex="0" x-cloak x-show="open">
                        <div class="grid grid-cols-2 gap-x-4 gap-y-10">
                            <div class="group relative">
                                <div class="aspect-h-1 aspect-w-1 overflow-hidden rounded-md bg-gray-100 group-hover:opacity-75">
                                    ...
                                    <div class="flex h-full justify-center space-x-8">
                                        <div class="flex">
                                            <div class="relative flex">
                                                <button type="button" @click="toggle()" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Women</button>
                                            </div>
                                            <div class="absolute inset-x-0 top-full text-sm text-gray-500 z-50" x-cloak x-show="open" x-transition>
                                        ...
                                        <div class="flex">
                                            <div class="relative flex">
                                                <button type="button" @click="toggle()" class="border-transparent text-gray-700 hover:text-gray-800 relative z-10 -mb-px flex items-center border-b-2 pt-px text-sm font-medium transition-colors duration-200 ease-out" aria-expanded="false">Men</button>
                                            </div>
                                            <div class="absolute inset-x-0 top-full text-sm text-gray-500 z-50" x-cloak x-show="open" x-transition>
                                                <!-- Presentational element used to render the bottom shadow, if we put the shadow on the actual panel it pokes out the top, so we use this shorter element to hide the top of the shadow -->
                                                <div class="absolute inset-0 top-1/2 bg-white shadow" aria-hidden="true"></div>
